...
- Serve a self-contained mobile page; Safari captures audio only after a tap and microphone permission. WebRTC without STUN/TURN carries encrypted audio directly over LAN. The setup page explains certificate installation/trust and links to the secure pairing page.
